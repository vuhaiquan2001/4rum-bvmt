  ...
  return (
    <div className='p-5 flex flex-col items-center'>
      <div className='text-2xl max-w-7xl mb-4 p-2 w-full border-y-[1px] border-r-[1px] border-l-8 border-[var(--sub-color)] bg-[var(--primary-color)] shadow-lg shadow-gray-300'>
          <span className='text-white font-semibold pl-2'>{topics.topicname}</span>
      </div>
      <div className='w-full max-w-7xl min-h-[100vh] bg-[var(--sub-bg-color)] shadow-sub-around h-auto flex flex-col rounded overflow-hidden'> 
        <div className='flex bg-[var(--sub-text-color)] items-center my-1 md:my-0 justify-between flex-wrap sm:flex-nowrap px-2 w-full min-h-[60px] shadow-xl'>
