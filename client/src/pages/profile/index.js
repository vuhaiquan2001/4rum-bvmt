        ...
        <div className='max-w-7xl w-full h-fit'>
            <section className='relative block h-[500px]'>
                <div className="absolute top-0 w-full h-full bg-top bg-cover" style={
                    {backgroundImage: `url("https://cdn.metatft.com/file/metatft/home/set7_bg.webp")`}
                }>
                            ...
                            <div className="flex flex-wrap justify-center">
                                <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                                    <div className="relative w-full">
                                        <img alt="..." src="https://www.metatft.com/app/Pengu/golden.png" className="shadow-xl rounded-full left-[50%] translate-x-[-50%] top-[-50px] lg:top-[-50%] h-auto align-middle border-none absolute  max-w-[150px]"/>
                                    </div>
                                </div>
