                ...
                <div className="container mx-auto px-4">
                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                        <div className="px-6 select-none min-h-[600px]">
                            ...
                            <div className="w-full sm:mt-28 lg:mt-0 lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                                <div className="py-6 flex justify-center  px-3 mt-32 sm:mt-0">   
                                    <button onClick={()=>setIsSetPassword(!issetpassword)} className="bg-[var(--primary-color)] w-32 mr-2 active:bg-[var(--sub-color)] hover:bg-[var(--sub-color)] uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                                    {issetpassword? 'User ': 'Password'}
                                    </button>         
                                    <button onClick={(e)=>handleUpdate(e)} className="bg-[var(--primary-color)] w-32 active:bg-[var(--sub-color)] hover:bg-[var(--sub-color)] uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                                    Đồng ý
                                    </button>    
                                </div>
                            </div>
