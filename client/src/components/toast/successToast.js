...
function SuccessToast({text}) {
  ...
  return (
    <div id="toast-success" className="flex z-50  fixed items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 animate-[slidein_ease_0.3s,fadeout_linear_1s_3s_forwards]" role="alert">
