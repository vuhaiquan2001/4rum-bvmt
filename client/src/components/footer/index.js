      ...
      <div className="flex flex-col justify-center max-w-[1140px] mx-auto">
        <div className="text-xs text-slate-500 py-1 text-center">
         Đây là sản phẩm RESTful API đầu tiên của tác giả, vì thế còn rất nhiều sai sót. Mong mọi người góp ý để giúp mình cải thiện.
          <div className="text-slate-600">Tác giả: Vũ Hải Quân</div>
          <div className="text-slate-600">Email: Vuhaiquan2k1@gmail.com</div>
          <a href="https://github.com/vuhaiquan2001"  className="text-slate-600 hover:underline">GitHub: https://github.com/vuhaiquan2001</a>
        </div>
      </div>
    </div>
  );
